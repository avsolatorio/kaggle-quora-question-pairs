...
def main():
    ...
    X_train, X_valid, y_train, y_valid = train_test_split(X_train, y_train, test_size=0.1, random_state=1006)
    ...
    bst = xgb.train(params, d_train, 5000, watchlist, early_stopping_rounds=150, verbose_eval=10)
